...
used in [Kaggle competitions](https://www.kaggle.com/). Please choose one of the following labs. The description of each lab and a pointer to the instructions are documented below. 
